<template>
  <q-page padding>
    ...
    <q-form @submit="updateInvoice" class="q-pa-md">
      ...
      <div class="row">
        <div class="col q-pa-md">
          <q-btn label="ذخیره ویرایش" type="submit" color="primary" />
        </div>
      </div>
    </q-form>
  </q-page>
  ...
  created() {
    api
      ...
      .then((response) => {
        ...
        this.buyerName=response.data.buyerName;
        this.number=response.data.number;
        this.description=response.data.description;
        this.totalPrice=response.data.totalPrice;
        this.totalDiscount=response.data.totalDiscount;
        this.payablePrice=response.data.payablePrice;
        this.invoiceRows=response.data.invoiceRows;
      })
      .catch((error) => {
        this.$q.notify({
          progress: true,
